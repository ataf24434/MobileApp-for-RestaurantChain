...
public class Route {
    ...
    Context context;
    String lang;
    ArrayList<Marker> step_m;
    ArrayList<Polyline> p;
    Route() {
        step_m = new ArrayList<Marker>();
        p = new ArrayList<Polyline>();
    }
...
//put initial point
                ...
                for(int i=1;i<stepsArray.length()-1;i++)
                {
